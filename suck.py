...
#Code by Shoukat Ali
#Created 9-01-2022
#My facebook (https://www.facebook.com/TheRealShoukatAali
...
def kontol():
    time.sleep(0.3)
    aahh("""\n\x1b[1;91m     ★彡[ꜱʜᴏᴜᴋᴀᴛ]彡★
\x1b[1;94m────────────────────────────────────────────────────
\x1b[1;97m [\x1b[1;94m•\x1b[1;92m•\x1b[1;97m] Author   : Shoukat Ali
\x1b[1;97m [\x1b[1;92m•\x1b[1;94m•\x1b[1;97m] Github   : https://github.com/theshoukat
\x1b[1;97m [\x1b[1;94m•\x1b[1;92m•\x1b[1;97m] Facebook : https://www.facebook.com/TheRealShoukatAali
\x1b[1;94m────────────────────────────────────────────────────""")

def jembut():
    print("""\n\x1b[1;91m ★彡[ꜱʜᴏᴜᴋᴀᴛ]彡★
\x1b[1;94m────────────────────────────────────────────────────
\x1b[1;97m [\x1b[1;92m+\x1b[1;97m] Author   : Shoukat Ali
\x1b[1;97m [\x1b[1;92m+\x1b[1;97m] Github   : https://github.com/theshoukat
\x1b[1;97m [\x1b[1;92m+\x1b[1;97m] Facebook : https://www.facebook.com/TheRealShoukatAali
\x1b[1;94m────────────────────────────────────────────────────""")

def yayanxd():
    yayan=input("\n\033[00m\t   [\033[96m Press Enter To Return\033[97m ] ")
    if yayan == "": 
       os.system("python suck.py")
    else:
    ...
    if yayan == "1" or yayan =="01":
         ...
         def masuk():
             try:
                   ...
                   print('\n\033[97m [\033[92m+\033[97m] \033[92mPlease Wait...')
             cek = {"cookie":cek}
             ...
             if "mbasic_logout_button" in str(ismi):
                     if "What do You Think Now" in str(ismi):
                           ...
                           try:
                                  requests.get(mbasic.format(parser(ismi,"html.parser").find("a",string="Language Indonesia")["href"]),cookies=cek)
                           except:
                                  pass
                     try:
         ...
         def getlike(react):
             like = requests.get(react,cookies=Cookie).content
             ...
             return id
         def bysearch(option):
             search = requests.get(option,cookies=cookie).content
         ...
         if __name__ == '__main__':
               try:
                   ...
                   if memek =="":
                         ...
                         os.system('xdg-open https://www.facbook.com/TheRealShoukatAali')
                         exit()                   	
         ...
         Shoukat()
         aahh("\n\033[1;92m Thank you for using my tools.\n  Don't forget To Follow My Facebook Profile\n\n")
